                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <?php $olddate= $sdm['dob']; ?>
                                <div class="col-md-11">    <input type="text"  name="dob" value="<?php echo $newdate= date('d-M-Y', strtotime($olddate))?>"   placeholder=""  required></div>
                            </div>                            
                        </div>
                    </div>          
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-male" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="text"  name="BMI" value="<?php echo $sdm['BMI']?>"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-11">    <input type="text"  name="health" value="<?php echo $sdm['health']?>"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-11">    <input type="text"  name="food"  value="<?php echo $sdm['food']?>"  placeholder="" required></div>
                            </div>                            
                        </div>
                    </div>  
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-11">    <input type="text"  name="fitness" value="YOGA (Low Intensity)"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-11">    <input type="text"  name="time" value="Mon-Sun 8:30 PM"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-hand-o-right" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="Height"  name="membership" value="6 Months"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-11">    <input type="text"  name="mempaid"  value="Yes"  placeholder="" required></div>
                            </div>                            
                        </div>
                    </div>  
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-hand-o-right" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="text"  name="promotion"  value="Student Promotion"  placeholder="" required></div>
                            </div>                            
                        </div>
                    </div>    
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-money" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="text"  name="propaid" value="Yes"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            ...
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-cutlery" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="Height"  name="diet" value="None"   placeholder="" required></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                        <div class="form-group">
                            <label for="eMail">Fitness Activity Recommendation:</label>
                            <div class="form-control row">
                                <div class="col-md-1">  <i class="fa fa-hand-o-right" aria-hidden="true"></i> </div>
                                <div class="col-md-11">    <input type="text"  name="recom"  value="None"  placeholder="" required></div>
                            </div>                            
                        </div>
                    </div>  
                    ...
                    <a href="index" style="font-size: 17px;font-family: math;font-weight: 700;width: 100px;" class="btn btn-danger">Back</a> 
                     </div>

                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                       <input type="submit" id="submit" name="update" style="font-size: 17px; font-family: math;font-weight: 700; float:right; width:140px !important; color:white !important;" class="btn btn-primary" value="Update Profile"> 
