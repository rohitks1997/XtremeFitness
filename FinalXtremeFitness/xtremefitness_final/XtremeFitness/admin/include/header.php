 <style>
  .app-header__logo {    background-color: #ad0a07;
    font-family: sans-serif;}
    .app-header {background-color: #ad0a07;}
 ...
 <header class="app-header"><a class="app-header__logo" href="index.php">Xtreme Fitness</a>
