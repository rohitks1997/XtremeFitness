...
.form-control:focus{box-shadow:none!important;}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!---Error Message--->
                      <center><h3 class="tile-title">Update Exercise & Fitness Activity</h3></center>
            <div class="tile-body">
              <form class="row" method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="excname" id="fdate" placeholder="Enter Excercise" value="<?php echo $p['name']?>">
                </div> 
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="file" name="img" id="fdate" placeholder="Enter Time Shedule" value=" <?php echo $p['img'];?>">
                </div>
        ...
        { value: 'Email', title: 'Email' },
                ...
                <div class="form-group col-md-6">
                  <label class="control-label">Exercise Description</label>
                    <textarea name="desc" id="editor"> <?php echo $p['text']?></textarea>
                </div>
                <div class="col-md-6" style="display: flex;justify-content: center;align-items: center;">
                <img src="<?php echo $p['img'];?>" alt="" style="width:180px; height:240px;">
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="text-align:justify;"><input class="form-control" type="text" name="trainer" id="fdate" placeholder="Enter Trainer Name" value="<?php echo $k['name']?>"></td>
                      ...
                      <!-- <h3 class="tile-title" style="font-size:18px;">Update Trainer </h3>  -->
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                              <td style="text-align:justify;"><input class="form-control" type="text" name="intensity" id="fdate" placeholder="Enter Intensity" value="<?php echo $n['added']?>"></td>
                      ...
                      <!-- <h3 class="tile-title" style="font-size:18px;">Update Trainer </h3>  -->
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                              <td style="text-align:justify;"><input class="form-control" type="text" name="time" id="fdate" placeholder="Enter Time" value="<?php echo $m['dtime']?>"></td>
