...
.add{color:#2d2d2d !important;}
          ...
          <div class="card h-100">
              <div class="card-body asd">
                  ...
                  <div class="row gutters">
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                          <h6 class="mb-2 text-primary">Promotion</h6>
                          <!-- <p>Enter your details to create your account</p> -->
                      </div>
                      ...
                      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                          <div class="form-group">
                              <label for="fullName">Promotion :</label>
                              <div class="form-control row">
                                  <div class="col-md-1">  <i class="fa fa-hand-o-right" aria-hidden="true"></i> </div>
                                  <div class="col-md-11">    <input type="text"  name="fitness" value="<?php echo $sdm['promotion']?>"   placeholder="Fitness Activity" ></div>
                              </div>
                          </div>
                      </div>
                      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
                          <div class="form-group">
                              ...
                              <div class="form-control row">
                                  <div class="col-md-1">  <i class="fa fa-hand-o-right" aria-hidden="true"></i> </div>
                                  <div class="col-md-11">    <input type="text"  name="fitness" value="<?php echo $sdm['promotionpay']?>"   placeholder="Enter Intensity" ></div>
                              </div>
                          </div>
                      </div>
                      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 5px;">
  ...
  <option value="<?php echo $sdm['promotionpaid']?>"> <?php echo $sdm['promotionpaid']?></option>
  ...
  <option value="Yes">Yes</option>
                      ...
                      <a href="upromo.php" style="font-size: 15px;font-family: sans-serif;font-weight: 500;width: 100px;" class="btn btn-danger">Back</a> 
                       </div>
...
<?php if (isset($_POST['update'])) {
    ...
    $run= "UPDATE `usignup` SET `fitr`='$fit',`diet`='$diet', `promotionpaid`='$paid' WHERE `id`=$id";
