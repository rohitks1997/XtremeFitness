...
<html lang="en">
  <head>
   ...
   <title>Admin | Update <?php echo $meme['uploadin'] ?> Promotion</title>
    <meta charset="utf-8">
...
.form-control:focus{box-shadow:none!important;}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!---Error Message--->
                      <center><h3 class="tile-title">Update <?php echo $meme['uploadin'] ?> Promotion</h3></center>
            <div class="tile-body">
              <form class="row" method="post"  enctype="multipart/form-data">
              

              <div class="form-group col-md-6">
                  <label class="control-label">Promotion Title</label>
                  <input class="form-control" type="text" name="title" id="fdate" placeholder="Enter Excercise" value="<?php echo $meme['title']?>">
              </div> 

              <div class="form-group col-md-6">
                    
                    <label class="control-label">Promotion Months</label>
                   
                    <input class="form-control" type="text" name="month" id="fdate" placeholder="Enter Month Name" value=" <?php echo $meme['month'];?>">
              </div>
              ...
              <div class="col-md-12" style="display: flex;justify-content: center;align-items: center;">
                <img src="<?php echo $meme['img'];?>" alt="" style="width:190px;">
                </div>
                <div class="form-group col-md-12">
                    
                    <label class="control-label">Promotion Image</label>
                ...
                <div class="form-group col-md-6 align-self-end">
                    <a href="addpromotion.php"  name="back" id="Submit" class="btn btn-danger"  style="float:right;">Back</a>
                </div>
     ...
     if(Isset($_POST['update']))
    {
        ...
        $run="UPDATE `member_pro` SET `title`='$title',`img`='$desp' , `month`='$month', `price`='$price',`text`='$desc' Where id = $id";
