    ...
    <main class="app-content">
       ...
       <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <center><h3>Promotion List</h3><hr></center>
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  <tr>
                    ...
                    <!-- <th class="text-center" style="vertical-align:middle;">Activity</th> -->
                    <th class="text-center" style="vertical-align:middle;">Promtotion</th>
...
?>
               ...
               <?php foreach ($result as $s ) {?>
                  <tr>
                    ...
                    <td class="text-center" style="vertical-align:middle;"><?php echo $s['promotion'] ;?> </td>
                    <td class="text-center" style="vertical-align:middle;"> <?php echo $s['promotionpay']?></td>
                    <td class="text-center" style="vertical-align:middle;"><?php echo $s['promotionpaid'] ;?> </td>
                    <td class="text-center" style="vertical-align:middle;"><a href="promotiondiet?id=<?php echo $s['id'] ;?>"><i class="fa fa-edit" style="color:red; font-size:17px;" aria-hidden="true"></i></a> </td>
