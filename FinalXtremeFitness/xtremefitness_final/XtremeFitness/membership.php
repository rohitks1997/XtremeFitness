...
$member="SELECT * FROM `member_pro` where `uploadin` = 'membership'";
...
<?php
           ...
           <form method="POST" class="members">
             ...
             <div class="form-group col-md-12"style="margin-top: 15px;">
               ...
               <div class="form-group col-md-6" style="margin-top: 15px;">
               <a href="membership.php">    <button type="button" class="btn btn-danger" data-dismiss="modal" style="float:left; width:100px;">Close</button>
               </a></div>
               <div class="form-group col-md-6" style="margin-top: 15px;">
...
`cvv`='$cvv', `exp`='$exp', `address`='$message' ,`memberpay`='$l[price]'  ,`member`='$l[title]'
WHERE `id`=$idd;
";
...
if ($pppp == true) {
  ...
  alert("Thank You for Membership.  Admin Will Contact You Soon !");
...
<div class="container-fluid" style="max-width:90%;">
        <h1 class="title-1">Memberships</h1>
        <h1 class="title-2">Please Select a Membership</h1>
  ...
  <?php foreach ($my as $aj) {?>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mt-5 mb-5">
                        <div class="card" style="width: 85%;">
                        <h1 style="margin-top:10%;margin-bottom:10%;color: #ac0300;font-size: 25px;font-weight:bold;"><?php echo $aj['title']?></h1>
                        <center><img class="card-img-top img-fluid" src="admin/<?php echo $aj['img']?>" alt="Card image cap" style="height: 300px;
                        width:99%;">
                        <h1 style="color: #ac0300;font-size: 25px;font-weight:bold;margin-top: 20px;"><?php echo $aj['price']?></h1>
                        
                        <h1 style="font-size:18px; margin-top:10%; margin-bottom: 5%"><?php echo $aj['text']?></h1>
                        <?php if(isset($_SESSION['logedin']) && $_SESSION['logedin']==true) { ?>
                              <a href="membership?ajid=<?php echo $aj['id']?>" class="btn btn-primary btn-2">Select</a></center>
                        <?php } else{ ?>
                             <a target="_blank" href="signin"  type="submit" name="text" class="btn btn-primary btn-2">Select</a>
                         <?php }?>
      ...
      <?php }?>
                ...
                <!-- <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        ...
                        <h1 style="font-family:math;color: #ac0300;font-size: 25px;font-weight:bold;margin-top: 20px;">3 Months Membership</h1>
                        <center><img class="card-img-top img-fluid" src="img/squatting.jpg" alt="Card image cap" style="height: 300px;
                        width:99%;">
                        <h1 style="font-family:math;color: #ac0300;font-size: 25px;font-weight:bold;margin-top: 20px;">Price: 3900 Baht</h1>
                        
                        <h1 style="font-family:math; font-size:25px; font-weight:bold; margin-top:10px;">Applicable To all Fitness Activity</h1>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <div class="card" style="width: 85%;border-top-left-radius: 20px;border-top-right-radius: 20px;">
                        <h1 style="font-family:math;color: #ac0300;font-size: 25px;font-weight:bold;margin-top: 20px;">6 Month Membership</h1>
                        <center><img class="card-img-top img-fluid" src="img/Gym Photo 2.jpg" alt="Card image cap" style="height: 300px;
                        width:99%;">
                        <h1 style="font-family:math;color: #ac0300;font-size: 25px;font-weight:bold;margin-top: 20px;">Price: 6900 Baht</h1>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        ?>
          ...
          <h4 class="modal-title" style=" color:darkred; font-weight:700;">3 Months Membership</h4>
        ...
        <div class="modal-body">
            <center><h3 style=" font-weight:700;">Payment</h3>
            <h4 class="modal-title" style=" color:darkred; font-weight:700;">Price: 3900 Baht</h4>
            </center>
            ...
            <form method="POST" class="members">
              <div class="row">
                ...
                <input type="text" class="form-control" name="number" id="subject" placeholder="Enter Email" required>
                </div>
